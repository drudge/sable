...
![Sable dashboard with query activity, response breakdowns, and client statistics](../assets/guide-screenshots/dashboard-full.webp "The dashboard gives you an overview after queries start arriving. Use the query log to verify an individual request. Preview capture; the release image will be refreshed for 1.0.0.")
