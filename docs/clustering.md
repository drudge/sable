...
![Cluster status showing member roles, generation lag, and synchronization health](assets/guide-screenshots/cluster-status.webp "Check role, generation lag, and last successful synchronization before maintenance. Sable 1.4.0 with demo data.")
