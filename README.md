...
- Dynamic DNS publication across multiple zones and providers through the same
  nine adapters as ACME DNS-01, with A/AAAA reconciliation, public-address
  discovery, and primary-only cluster execution
