...
Set `SABLE_VERSION=0.9.4-rc.7` to install a specific release. Re-running either
...
| `--version v0.9.4-rc.7` | Install a specific release tag, including older ones |
...
docker run --detach --name sable --restart unless-stopped \
  ...
  ghcr.io/drudge/sable:0.9.4-rc.7
```
