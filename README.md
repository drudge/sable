...
Set `SABLE_VERSION=0.8.0-rc.9` to install a specific release. Re-running either
...
| `--version v0.8.0-rc.9` | Install a specific release tag, including older ones |
...
docker run --detach --name sable --restart unless-stopped \
  ...
  ghcr.io/drudge/sable:0.8.0-rc.9
```
