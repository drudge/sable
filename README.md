...
Set `SABLE_VERSION=0.9.2-rc.1` to install a specific release. Re-running either
...
| `--version v0.9.2-rc.1` | Install a specific release tag, including older ones |
...
docker run --detach --name sable --restart unless-stopped \
  ...
  ghcr.io/drudge/sable:0.9.2-rc.1
```
