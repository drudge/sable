...
func New(
	...
	mux.HandleFunc("POST /ui/zones/import-catalog", server.importCatalog)
	...
	mux.HandleFunc("POST /ui/zones/convert-primary", server.convertZoneToPrimary)
	mux.HandleFunc("GET /api/v1/zones/convert-primary", server.reviewZoneConversion)
	mux.HandleFunc("POST /api/v1/zones/convert-primary", server.convertZoneToPrimary)
