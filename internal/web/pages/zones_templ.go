		...
		if view.Error != "" {
			...
			if len(view.Changes) > 0 {
				...
				for _, change := range view.Changes {
					var templ_7745c5c3_Var75 = []any{change.Kind}
...
func ZoneActionMenu(zone ZoneView, className, settingsID, dnssecID, cloneID, deleteID string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		var templ_7745c5c3_Var87 = []any{"zone-action-menu " + className}
		...
		var templ_7745c5c3_Var89 = []any{ifThen(className == "", "icon-button zone-more-button", "icon-button")}
